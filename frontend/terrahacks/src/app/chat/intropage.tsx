  ...
  const sections = [
    {
      id: 'hero',
      title: 'NanoWorks',
      description: 'Utilizing the power of AI to create and innovate at the nanoscopic level',
      videoTime: .10
    },
    {
      id: 'why',
    ...
    <div ref={containerRef} className="relative">
        ...
        {isIn3SecondPlay && (
          <div className={`absolute top-8 left-8 z-20 ${styles.initialPlayIndicator}`}>
            <div className="flex items-center space-x-3 bg-black/50 backdrop-blur-sm rounded-full px-4 py-2">
              ...
              <span className="text-white text-sm font-medium">Intro Playing...</span>
      ...
      <div className="relative z-10">
        {sections.map((section, index) => (
          <section
            key={section.id}
            id={`section-${index}`}
            className={`min-h-screen flex items-center ${index === 0 ? 'justify-center' : 'justify-start'} px-8 md:px-16 lg:px-24 relative ${styles.snapSection} ${index > 0 ? styles.futuristicSection : ''}`}
          >
            ...
            {index > 0 && (
              <>
                ...
                {/* Energy Pulse Points */}
                <div className={styles.energyPulse} style={{left: '20%', top: '30%', animationDelay: '0.5s'}} />
                <div className={styles.energyPulse} style={{left: '80%', top: '70%', animationDelay: '1.5s'}} />
            ...
            <div className={`${index === 0 ? 'max-w-5xl w-full text-center' : 'max-w-3xl'} text-white relative z-10 ${
              ...
              <div className={`transition-all duration-1000 ${
                ...
                <h1 className={`font-bold mb-4 ${
                  section.id === 'hero' 
                    ? styles.textGlow + ' text-5xl md:text-7xl lg:text-8xl mb-8'
                    : styles.holographicText + ' text-4xl md:text-6xl lg:text-7xl'
                }`}>
                  {section.title}
                </h1>
                ...
                {section.subtitle && (
                  <h2 className={`font-light mb-8 opacity-70 ${
                    section.id === 'hero' 
                      ...
                      : 'text-2xl md:text-4xl lg:text-5xl ' + styles.holographicText
                  }`}>
                    {section.subtitle}
                  </h2>
                )}
                ...
                <p className={`text-lg md:text-xl leading-relaxed opacity-90 mb-8 ${
                  section.id === 'hero' ? 'text-slate-300 max-w-3xl mx-auto' : 'max-w-2xl'
                }`}>
                  {section.description}
                </p>
                ...
                {section.id === 'why' && (
                  <div className="mt-8">
                    <div className="relative">
                      ...
                      <div className="absolute -top-1 left-0 w-2 h-3 bg-blue-400 rounded-full animate-bounce" style={{animationDelay: '0.5s'}} />
                      <div className="absolute -bottom-1 right-4 w-1 h-2 bg-purple-400 rounded-full animate-ping" style={{animationDelay: '1s'}} />
                    </div>
                ...
                {section.id === 'how' && (
                  <div className="mt-8">
                    <div className="flex space-x-3 items-center">
                      ...
                      <div className="w-24 h-1 bg-purple-400 rounded-full animate-pulse" style={{animationDelay: '0.5s'}} />
                      <div className="w-12 h-1 bg-blue-300 rounded-full animate-pulse" style={{animationDelay: '1s'}} />
                    </div>
                    <div className="mt-4 flex space-x-4 text-xs font-mono text-blue-300">
                      <span className="animate-pulse">BUILD.STATUS: OK</span>
                      <span className="animate-pulse" style={{animationDelay: '0.3s'}}>COMPILE.TIME: 0.42s</span>
                      <span className="animate-pulse" style={{animationDelay: '0.6s'}}>ERRORS: 0</span>
                    </div>
                  </div>
                )}
                  ...
                  <div className="mt-8">
                    <div className="flex items-center space-x-6">
                      <div className="relative">
                        ...
                        <div className="absolute inset-2 border border-purple-400 rounded-full animate-spin" style={{animationDirection: 'reverse', animationDuration: '3s'}} />
                        <div className="absolute inset-4 w-4 h-4 bg-blue-400 rounded-full animate-pulse" />
                      </div>
                      <div className="space-y-1">
                        <div className="text-blue-400 text-sm font-mono tracking-wider">NEURAL_NETWORK.ACTIVE</div>
                        <div className="flex space-x-1">
                          <div className="w-2 h-2 bg-blue-400 rounded-full animate-pulse" />
                          <div className="w-2 h-2 bg-purple-400 rounded-full animate-pulse" style={{animationDelay: '0.2s'}} />
                          <div className="w-2 h-2 bg-blue-300 rounded-full animate-pulse" style={{animationDelay: '0.4s'}} />
                          <div className="w-2 h-2 bg-purple-300 rounded-full animate-pulse" style={{animationDelay: '0.6s'}} />
                        </div>
                        <div className="text-xs text-blue-300 font-mono opacity-70">AI.PROCESSING: 97.3%</div>
                      </div>
                    </div>
                  </div>
                )}
      ...
      {currentSection > 0 && (
        <div className={styles.molecularContainer}>
          <div className={`${styles.molecularStructure} ${shouldRotate ? styles.rotating : ''}`}>
            {/* Central Atom */}
